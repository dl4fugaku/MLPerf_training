...
_set('BASE_DIR', '$PWD/runs/results/minigo/current.$HOST.$NOWSHORT/')
...
_set('NUM_PARALLEL_SELFPLAY', 32)

_set('EVAL_GAMES_PER_SIDE', 32)
_set('EVAL_WIN_PCT_FOR_NEW_MODEL', 0.55)
_set('EVALUATE_MODELS', True)

_set('EVALUATE_PUZZLES', True)
_set('TRIES_PER_PUZZLE', 5)
_set('SP_READOUTS', 32)
_set('TERMINATION_ACCURACY', 0.10)
