...
def download_dataset(raw_data_dir):
  ...
  for tarf in [tarfiles for _,_,tarfiles in os.walk('/work/data/images/ILSVRC2012_img_train')][0]:
    subdirectory = os.path.join(directory, tarf.split('.')[0])
    sub_tarfile = os.path.join('/work/data/images/ILSVRC2012_img_train', tarf)
  ...
  _check_or_create_dir(directory)
  c=0
  for imgfile in [imgfiles for _,_,imgfiles in os.walk('/work/data/images/ILSVRC2012_img_val')][0]:
    c+=1
    shutil.copyfile(os.path.join('/work/data/images/ILSVRC2012_img_val', imgfile), os.path.join(directory, imgfile))
    if c%100 == 0: print('Files copied:', c)
